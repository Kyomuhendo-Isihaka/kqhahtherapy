                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <a href="apps-ecommerce-product-overview.html"
                                                    ...
                                                    <img src="{{ asset('uploads/kqhahtherapy.jpeg') }}" alt="Product images"
                                                        class="h-6">
                                                    <h6 class="product_name">Product</h6>
                                                </a>
                                            </td>
                                            ...
                                            <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                                <div class="flex gap-2">
                                                    <div class="edit">
                                                        <button data-modal-target="showModa" class="text-slate-400"><i
                                                                data-lucide="eye"></i></button>
                                                    </div>
                                                    <div class="edit">
                                                        <button data-modal-target="showModa" class="text-custom-400"><i
                                                                data-lucide="edit"></i></button>
                                                    </div>
                                                    <div class="remove">
                                                        <button data-modal-target="deleteModal" id="delete-record"
                                                            class="text-red-500"><i data-lucide="trash"></i></button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <tbody class="list">
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <div class="flex gap-2">
                                                            <div class="edit">
                                                                <button data-modal-target="showModa"
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="mt-5 text-center">
                                                                    ...
                                                                    <p class="text-slate-500 dark:text-zink-200">Are you
                                                                        ...
                                                                        this
                                                                        record?</p>
                                                                        <form action="{{ route('pricing.destroy', $p->id) }}" method="POST">
                                                                            @csrf
