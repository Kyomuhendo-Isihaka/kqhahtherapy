...
<body class="flex items-center justify-center min-h-screen py-16 lg:py-10 bg-slate-50 dark:bg-zink-800 dark:text-zink-100 font-public">
    ...
    <div class="mb-0 border-none lg:w-[500px] card bg-white/70 shadow-none dark:bg-zink-500/70">
        <div class="!px-10 !py-12 card-body">
            <a href="index-1.html">
                <img src="{{ asset('uploads/kqhahtherapy.jpeg') }}" alt="" class="hidden h-6 mx-auto dark:block">
                <img src="{{ asset('uploads/kqhahtherapy.jpeg') }}" alt="" class="block h-6 mx-auto dark:hidden">
            </a>
